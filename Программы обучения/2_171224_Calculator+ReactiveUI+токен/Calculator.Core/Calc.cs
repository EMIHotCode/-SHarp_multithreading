...
public static class Calc
{
        ...
        IProgress<int>? progress = null)
    {
        ...
        for (int i = number; i >= 1;  i--)
        {
            ...
            progress?.Report(number - i);  // оповещаем шкалу 
            
            await Task.Delay(100, cancellationToken);   // вызываем задержку на 100 мс у каждого асинхронного вызова счетчика
            
            result *= i; // щитаем значение 
        }
