...
namespace testing_ezhednevnik2
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void leftDatePicker_Click(object sender, RoutedEventArgs e)
        {
            if (Date.SelectedDate != null)
                Date.SelectedDate = Date.SelectedDate.Value.AddDays(-1);
                clearAllNote();
        }
        private void rightDatePicker_Click(object sender, RoutedEventArgs e)
        {
            if (Date.SelectedDate != null)
                Date.SelectedDate = Date.SelectedDate.Value.AddDays(1);
            clearAllNote();
