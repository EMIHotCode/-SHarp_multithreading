...
namespace PhoneBook.DAL.Migrations
{
    ...
    [Migration("20250209213947_DeleteAttributePersonId")]
    partial class DeleteAttributePersonId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PBook.Server_Model.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PBook.Server_Model.Phone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PBook.Server_Model.Phone", b =>
                {
                    b.HasOne("PBook.Server_Model.Person", "Person")
                        .WithMany("Phones")
